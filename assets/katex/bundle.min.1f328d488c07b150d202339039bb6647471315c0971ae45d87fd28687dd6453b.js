(() => {
      ...
      (function webpackUniversalModuleDefinition(root, factory) {
        ...
        return (
          ...
          (function() {
            ...
            class Settings {
              constructor(options2) {
                ...
                for (const prop of Object.keys(SETTINGS_SCHEMA)) {
                  ...
                  const optionValue = options2[prop];
            ...
            defineSymbol(symbols_text, main, textord, "\u22C5", "\xB7");
            ...
            const wideCharacterFont = (wideChar2, mode) => {
            ...
            const buildExpression = function(expression, options2, isRealGroup, surrounding) {
              ...
              const dummyPrev = makeSpan([surrounding[0] || "leftmost"], [], options2);
              const dummyNext = makeSpan([surrounding[1] || "rightmost"], [], options2);
            ...
            const buildGroup = function(group, options2, baseOptions) {
              ...
              if (_htmlGroupBuilders[group.type]) {
                ...
                if (baseOptions && options2.size !== baseOptions.size) {
                  groupNode = makeSpan(options2.sizingClasses(baseOptions), [groupNode], options2);
            ...
            function buildHTMLUnbreakable(children, options2) {
              const body = makeSpan(["base"], children, options2);
            ...
            function buildHTML(tree, options2) {
              ...
              let tagChild;
              if (tag) {
                tagChild = buildHTMLUnbreakable(buildExpression(tag, options2, true), options2);
            ...
            const stretchySvg = function(group, options2) {
              function buildSvgSpan_() {
                ...
                if (wideAccentLabels.has(label)) {
                  ...
                  return {
                    span: makeSvgSpan([], [svgNode], options2),
                    minWidth: 0,
                    height: height2
                  };
                } else {
                  ...
                  for (let i = 0; i < numSvgChildren; i++) {
                    ...
                    const span2 = makeSvgSpan([widthClasses[i]], [svgNode], options2);
                    if (numSvgChildren === 1) {
                      return {
                        span: span2,
                        minWidth: minWidth2,
                  ...
                  return {
                    span: makeSpan(["stretchy"], spans, options2),
                    minWidth: minWidth2,
                    height: height2
                  };
                }
            ...
            const stretchyEnclose = function(inner2, label, topPad, bottomPad, options2) {
              let img;
              const totalHeight = inner2.height + inner2.depth + topPad + bottomPad;
              if (/fbox|color|angl/.test(label)) {
                img = makeSpan(["stretchy", label], [], options2);
                if (label === "fbox") {
                ...
                img = makeSvgSpan([], [svgNode], options2);
              }
            ...
            const htmlBuilder = (grp, options2) => {
              ...
              if (!group.isStretchy) {
                ...
                let width;
                if (group.label === "\\vec") {
                  accent2 = staticSvg("vec", options2);
                  width = svgData.vec[1];
                } else {
                  accent2 = makeOrd({
                    type: "textord",
                ...
                accentBody = stretchySvg(group, options2);
                accentBody = makeVList({
                  positionType: "firstBaseline",
                  children: [{
                    type: "elem",
              ...
              const accentWrap = makeSpan(["mord", "accent"], [accentBody], options2);
              if (supSubGroup) {
            ...
            const mathmlBuilder = (group, options2) => {
              ...
              const node = new MathNode("mover", [buildMathML_buildGroup(group.base, options2), accentNode]);
            ...
            defineFunction({
              ...
              htmlBuilder: (group, options2) => {
                ...
                const accentBody = stretchySvg(group, options2);
                ...
                return makeSpan(["mord", "accentunder"], [vlist], options2);
              },
              mathmlBuilder: (group, options2) => {
                const accentNode = stretchyMathML(group.label);
                const node = new MathNode("munder", [buildMathML_buildGroup(group.base, options2), accentNode]);
            ...
            defineFunction({
              ...
              htmlBuilder(group, options2) {
                ...
                const upperGroup = wrapFragment(buildGroup(group.body, newOptions, options2), options2);
                const arrowPrefix = group.label.slice(0, 2) === "\\x" ? "x" : "cd";
                upperGroup.classes.push(arrowPrefix + "-arrow-pad");
                let lowerGroup;
                if (group.below) {
                  newOptions = options2.havingStyle(style.sub());
                  lowerGroup = wrapFragment(buildGroup(group.below, newOptions, options2), options2);
                  lowerGroup.classes.push(arrowPrefix + "-arrow-pad");
                }
                const arrowBody = stretchySvg(group, options2);
            ...
            defineFunction({
              ...
              htmlBuilder(group, options2) {
                const elements = buildExpression(group.body, options2, true);
                const node = makeSpan([group.mclass], elements, options2);
            ...
            defineFunction({
              ...
              htmlBuilder(group, options2) {
                ...
                const label = wrapFragment(buildGroup(group.label, newOptions, options2), options2);
              ...
              mathmlBuilder(group, options2) {
                let label = new MathNode("mrow", [buildMathML_buildGroup(group.label, options2)]);
            ...
            defineFunction({
              ...
              htmlBuilder(group, options2) {
                const parent = wrapFragment(buildGroup(group.fragment, options2), options2);
                parent.classes.push("cd-vert-arrow");
                return parent;
              },
              mathmlBuilder(group, options2) {
                return new MathNode("mrow", [buildMathML_buildGroup(group.fragment, options2)]);
              }
            });
            ;
            defineFunction({
            ...
            defineFunction({
              ...
              htmlBuilder(group, options2) {
                const span = makeSpan(["mspace"], [], options2);
                if (group.newLine) {
            ...
            const styleWrap = function(delim, toStyle, options2, classes) {
              ...
              const span = makeSpan(classes.concat(newOptions.sizingClasses(options2)), [delim], options2);
            ...
            const makeSmallDelim = function(delim, style, center, options2, mode, classes) {
              const text = makeSymbol(delim, "Main-Regular", mode, options2);
            ...
            const mathrmSize = function(value, size, mode, options2) {
              return makeSymbol(value, "Size" + size + "-Regular", mode, options2);
            };
            const makeLargeDelim = function(delim, size, center, options2, mode, classes) {
              const inner2 = mathrmSize(delim, size, mode, options2);
              const span = styleWrap(makeSpan(["delimsizing", "size" + size], [inner2], options2), src_Style.TEXT, options2, classes);
              if (center) {
            ...
            const makeInner = function(ch, height, options2) {
              ...
              const span = makeSvgSpan([], [svgNode], options2);
              span.height = height;
              span.style.height = makeEm(height);
              span.style.width = makeEm(width);
              return {
            ...
            const makeStackedDelim = function(delim, heightTotal, center, options2, mode, classes) {
              ...
              if (svgLabel.length > 0) {
                ...
                const wrapper = makeSvgSpan([], [svg], options2);
              ...
              return styleWrap(makeSpan(["delimsizing", "mult"], [inner2], newOptions), src_Style.TEXT, options2, classes);
            };
            const vbPad = 80;
            const emPad = 0.08;
            const sqrtSvg = function(sqrtName, height, viewBoxHeight, extraVinculum, options2) {
              ...
              return makeSvgSpan(["hide-tail"], [svg], options2);
            };
            ...
            const traverseSequence = function(delim, height, sequence, options2) {
              ...
              for (let i = start; i < sequence.length; i++) {
                ...
                if (delimType.type === "small") {
                  const newOptions = options2.havingBaseStyle(delimType.style);
            ...
            defineFunction({
              ...
              htmlBuilder: (group, options2) => {
                ...
                return makeSizedDelim(group.delim, group.size, options2, group.mode, [group.mclass]);
              },
              mathmlBuilder: (group) => {
                const children = [];
                if (group.delim !== ".") {
            ...
            defineFunction({
              ...
              htmlBuilder: (group, options2) => {
                ...
                if (group.left === ".") {
                  ...
                  leftDelim = makeLeftRightDelim(group.left, innerHeight, innerDepth, options2, group.mode, ["mopen"]);
                }
                ...
                return makeSpan(["minner"], inner2, options2);
              },
              mathmlBuilder: (group, options2) => {
                assertParsed(group);
                const inner2 = buildMathML_buildExpression(group.body, options2);
            ...
            defineFunction({
              ...
              htmlBuilder: (group, options2) => {
                ...
                if (group.delim === ".") {
                  ...
                  middleDelim = makeSizedDelim(group.delim, 1, options2, group.mode, []);
                  const isMiddle = {
                    delim: group.delim,
                    options: options2
                  };
            ...
            const enclose_htmlBuilder = (group, options2) => {
              const inner2 = wrapFragment(buildGroup(group.body, options2), options2);
              const label = group.label.slice(1);
              ...
              if (label === "sout") {
                ...
                img = makeSvgSpan(["hide-tail"], [svgNode], options2);
                ...
                img = stretchyEnclose(inner2, label, topPad, bottomPad, options2);
              ...
              if (/cancel/.test(label) && !isSingleChar) {
                return makeSpan(["mord", "cancel-lap"], [vlist], options2);
              } else {
                return makeSpan(["mord"], [vlist], options2);
              }
            };
            const enclose_mathmlBuilder = (group, options2) => {
              let fboxsep = 0;
              const node = new MathNode(group.label.includes("colorbox") ? "mpadded" : "menclose", [buildMathML_buildGroup(group.body, options2)]);
              switch (group.label) {
                case "\\cancel":
            ...
            const array_htmlBuilder = function(group, options2) {
              ...
              if (group.tags && group.tags.some((tag) => tag)) {
                for (r = 0; r < nr; ++r) {
                  ...
                  let tagSpan;
                  if (tag === true) {
                    tagSpan = makeSpan(["eqn-num"], [], options2);
                  } else if (tag === false) {
                    tagSpan = makeSpan([], [], options2);
                  } else {
                    tagSpan = makeSpan([], buildExpression(tag, options2, true), options2);
                  }
              ...
              for (
                ...
                while (((_colDescr = colDescr) == null ? void 0 : _colDescr.type) === "separator") {
                  ...
                  if (colDescr.separator === "|" || colDescr.separator === ":") {
                    ...
                    const separator = makeSpan(["vertical-separator"], [], options2);
              ...
              if (hlines.length > 0) {
                const line = makeLineSpan("hline", options2, ruleThickness);
                const dashes = makeLineSpan("hdashline", options2, ruleThickness);
                const vListElems = [{
                  type: "elem",
                  elem: tableBody,
                  shift: 0
              ...
              if (tagSpans.length === 0) {
                return makeSpan(["mord"], [tableBody], options2);
              } else {
                const eqnNumCol = makeVList({
                  positionType: "individualShift",
                  children: tagSpans
                }, options2);
                const tagCol = makeSpan(["tag"], [eqnNumCol], options2);
            ...
            const array_mathmlBuilder = function(group, options2) {
              ...
              for (let i = 0; i < group.body.length; i++) {
                ...
                for (let j = 0; j < rw.length; j++) {
                  row.push(new MathNode("mtd", [buildMathML_buildGroup(rw[j], options2)]));
                }
            ...
            const genfrac_htmlBuilder = (group, options2) => {
              ...
              if (group.hasBarLine) {
                if (group.barSize) {
                  ...
                  rule = makeLineSpan("frac-line", options2, ruleWidth);
                } else {
                  rule = makeLineSpan("frac-line", options2);
                }
              ...
              if (group.leftDelim == null) {
                ...
                leftDelim = makeCustomSizedDelim(group.leftDelim, delimSize, true, options2.havingStyle(style), group.mode, ["mopen"]);
              }
              if (group.continued) {
                rightDelim = makeSpan([]);
                ...
                rightDelim = makeCustomSizedDelim(group.rightDelim, delimSize, true, options2.havingStyle(style), group.mode, ["mclose"]);
              }
              return makeSpan(["mord"].concat(newOptions.sizingClasses(options2)), [leftDelim, makeSpan(["mfrac"], [frac]), rightDelim], options2);
            };
            const genfrac_mathmlBuilder = (group, options2) => {
              const node = new MathNode("mfrac", [buildMathML_buildGroup(group.numer, options2), buildMathML_buildGroup(group.denom, options2)]);
              if (!group.hasBarLine) {
            ...
            const horizBrace_htmlBuilder = (grp, options2) => {
              ...
              const braceBody = stretchySvg(group, options2);
              let vlist;
              if (group.isOver) {
                vlist = makeVList({
                  positionType: "firstBaseline",
              ...
              if (supSubGroup) {
                const vSpan = makeSpan(["minner", group.isOver ? "mover" : "munder"], [vlist], options2);
                if (group.isOver) {
                  vlist = makeVList({
                    positionType: "firstBaseline",
                    children: [{
              ...
              return makeSpan(["minner", group.isOver ? "mover" : "munder"], [vlist], options2);
            };
            const horizBrace_mathmlBuilder = (group, options2) => {
              const accentNode = stretchyMathML(group.label);
              return new MathNode(group.isOver ? "mover" : "munder", [buildMathML_buildGroup(group.base, options2), accentNode]);
            };
            defineFunction({
              type: "horizBrace",
            ...
            defineFunction({
              ...
              htmlBuilder: (group, options2) => {
                ...
                return makeAnchor(group.href, [], elements, options2);
              },
              mathmlBuilder: (group, options2) => {
            ...
            defineFunction({
              ...
              mathmlBuilder(group, options2) {
                return new MathNode("mrow", buildMathML_buildExpression(group.body, options2));
              }
            });
            ;
            defineFunction({
              ...
              htmlBuilder: (group, options2) => {
                ...
                const span = makeSpan(classes, elements, options2);
            ...
            defineFunction({
              ...
              htmlBuilder(group, options2) {
                return makeGlue(group.dimension, options2);
              },
              mathmlBuilder(group, options2) {
            ...
            defineFunction({
              ...
              htmlBuilder: (group, options2) => {
                ...
                if (group.alignment === "clap") {
                  inner2 = makeSpan([], [buildGroup(group.body, options2)]);
                  inner2 = makeSpan(["inner"], [inner2], options2);
                } else {
                  inner2 = makeSpan(["inner"], [buildGroup(group.body, options2)]);
                }
                const fix = makeSpan(["fix"], []);
                let node = makeSpan([group.alignment], [inner2, fix], options2);
                const strut = makeSpan(["strut"]);
                ...
                node = makeSpan(["thinbox"], [node], options2);
                return makeSpan(["mord", "vbox"], [node], options2);
              },
              mathmlBuilder: (group, options2) => {
                const node = new MathNode("mpadded", [buildMathML_buildGroup(group.body, options2)]);
            ...
            const assembleSupSub = (base, supGroup, subGroup, options2, style, slant, baseShift) => {
              ...
              if (sub2 && slant !== 0 && !subIsSingleCharacter) {
                const spacer = makeSpan(["mspace"], [], options2);
                spacer.style.marginRight = makeEm(slant);
                parts.unshift(spacer);
              }
              return makeSpan(["mop", "op-limits"], parts, options2);
            };
            ;
            ...
            const op_htmlBuilder = (grp, options2) => {
              ...
              if (group.symbol) {
                ...
                base = makeSymbol(group.name, fontName, "math", options2, ["mop", "op-symbol", large ? "large-op" : "small-op"]);
                if (stash.length > 0) {
                  const italic = base.italic;
                  const oval = staticSvg(stash + "Size" + (large ? "2" : "1"), options2);
                  base = makeVList({
                    positionType: "individualShift",
                    children: [{
                      type: "elem",
                ...
                if (inner2.length === 1 && inner2[0] instanceof SymbolNode) {
                  ...
                  base = makeSpan(["mop"], inner2, options2);
                }
              } else {
                const output = [];
                for (let i = 1; i < group.name.length; i++) {
                  output.push(mathsym(group.name[i], group.mode, options2));
                }
                base = makeSpan(["mop"], output, options2);
              }
              let baseShift = 0;
              let slant = 0;
            ...
            const operatorname_htmlBuilder = (grp, options2) => {
              ...
              if (group.body.length > 0) {
                ...
                base = makeSpan(["mop"], expression, options2);
              } else {
                base = makeSpan(["mop"], [], options2);
              }
              if (hasLimits) {
            ...
            defineFunctionBuilders({
              ...
              htmlBuilder(group, options2) {
                if (group.semisimple) {
                  return makeFragment(buildExpression(group.body, options2, false));
                }
                return makeSpan(["mord"], buildExpression(group.body, options2, true), options2);
              },
              mathmlBuilder(group, options2) {
            ...
            defineFunction({
              ...
              htmlBuilder(group, options2) {
                ...
                const line = makeLineSpan("overline-line", options2);
                ...
                return makeSpan(["mord", "overline"], [vlist], options2);
              },
              mathmlBuilder(group, options2) {
                const operator = new MathNode("mo", [new TextNode("\u203E")]);
                operator.setAttribute("stretchy", "true");
                const node = new MathNode("mover", [buildMathML_buildGroup(group.body, options2), operator]);
                node.setAttribute("accent", "true");
                return node;
              }
            });
            ...
            defineFunction({
              ...
              htmlBuilder: (group, options2) => {
                const inner2 = makeSpan(["inner"], [buildGroup(group.body, options2.withPhantom())]);
                const fix = makeSpan(["fix"], []);
                return makeSpan(["mord", "rlap"], [inner2, fix], options2);
              },
              mathmlBuilder: (group, options2) => {
            ...
            defineFunction({
              ...
              htmlBuilder(group, options2) {
                const rule = makeSpan(["mord", "rule"], [], options2);
                const width = calculateSize(group.width, options2);
                const height = calculateSize(group.height, options2);
            ...
            defineFunction({
              ...
              htmlBuilder: (group, options2) => {
                const node = makeSpan([], [buildGroup(group.body, options2)]);
                ...
                if (group.smashHeight && group.smashDepth) {
                  return makeSpan(["mord", "smash"], [node], options2);
                }
                if (node.children) {
                ...
                return makeSpan(["mord"], [smashedNode], options2);
              },
              mathmlBuilder: (group, options2) => {
                const node = new MathNode("mpadded", [buildMathML_buildGroup(group.body, options2)]);
                if (group.smashHeight) {
            ...
            defineFunction({
              ...
              htmlBuilder(group, options2) {
                ...
                inner2 = wrapFragment(inner2, options2);
                ...
                const {
                  ...
                  ruleWidth,
                  advanceWidth
                } = makeSqrtImage(minDelimiterHeight, options2);
              ...
              mathmlBuilder(group, options2) {
                ...
                return index ? new MathNode("mroot", [buildMathML_buildGroup(body, options2), buildMathML_buildGroup(index, options2)]) : new MathNode("msqrt", [buildMathML_buildGroup(body, options2)]);
              }
            });
            ;
            ...
            defineFunctionBuilders({
              ...
              htmlBuilder(group, options2) {
                ...
                return makeSpan([mclass], [base, makeSpan(["msupsub"], [supsub])], options2);
              },
              mathmlBuilder(group, options2) {
                let isBrace = false;
                let isOver;
            ...
            defineFunctionBuilders({
              type: "atom",
              htmlBuilder(group, options2) {
                return mathsym(group.text, group.mode, options2, ["m" + group.family]);
              },
              mathmlBuilder(group, options2) {
            ...
            defineFunctionBuilders({
              type: "mathord",
              htmlBuilder(group, options2) {
                return makeOrd(group, options2, "mathord");
              },
              mathmlBuilder(group, options2) {
                const node = new MathNode("mi", [makeText(group.text, group.mode, options2)]);
            ...
            defineFunctionBuilders({
              type: "textord",
              htmlBuilder(group, options2) {
                return makeOrd(group, options2, "textord");
              },
              mathmlBuilder(group, options2) {
            ...
            defineFunctionBuilders({
              ...
              htmlBuilder(group, options2) {
                if (regularSpace.hasOwnProperty(group.text)) {
                  ...
                  if (group.mode === "text") {
                    const ord = makeOrd(group, options2, "textord");
                    ord.classes.push(className);
                    return ord;
                  } else {
                    return makeSpan(["mspace", className], [mathsym(group.text, group.mode, options2)], options2);
                  }
                } else if (cssSpace.hasOwnProperty(group.text)) {
                  return makeSpan(["mspace", cssSpace[group.text]], [], options2);
                } else {
            ...
            defineFunctionBuilders({
              type: "tag",
              mathmlBuilder(group, options2) {
                const table = new MathNode("mtable", [new MathNode("mtr", [pad(), new MathNode("mtd", [buildExpressionRow(group.body, options2)]), pad(), new MathNode("mtd", [buildExpressionRow(group.tag, options2)])])]);
            ...
            defineFunction({
              ...
              htmlBuilder(group, options2) {
                ...
                const line = makeLineSpan("underline-line", options2);
                const defaultRuleThickness = options2.fontMetrics().defaultRuleThickness;
                const vlist = makeVList({
                  positionType: "top",
                  positionData: innerGroup.height,
                ...
                return makeSpan(["mord", "underline"], [vlist], options2);
              },
              mathmlBuilder(group, options2) {
                const operator = new MathNode("mo", [new TextNode("\u203E")]);
                operator.setAttribute("stretchy", "true");
                const node = new MathNode("munder", [buildMathML_buildGroup(group.body, options2), operator]);
                node.setAttribute("accentunder", "true");
                return node;
              }
            });
            ...
            defineFunction({
              ...
              mathmlBuilder(group, options2) {
                const mpadded = new MathNode("mpadded", [buildMathML_buildGroup(group.body, options2)], ["vcenter"]);
        ...
        return (
          ...
          (function() {
            ...
            const renderMathInElement2 = function(elem, options2) {
              ...
              const optionsCopy = {};
              Object.assign(optionsCopy, options2);
              ...
              optionsCopy.ignoredTags = new Set((options2 == null ? void 0 : options2.ignoredTags) || ["script", "noscript", "style", "textarea", "pre", "code", "option"]);
  ...
  // ns-hugo-imp:C:\Users\xiaochai_123\Desktop\myblog\themes\hugo-theme-bootstrap\assets\katex\js\options.ts
  var options = {
    delimiters: [
      {
        display: true,
