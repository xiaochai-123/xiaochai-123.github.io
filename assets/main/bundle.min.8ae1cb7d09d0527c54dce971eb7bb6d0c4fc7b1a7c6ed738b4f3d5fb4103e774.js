(() => {
  ...
  var code_block_default = { baseURL: "http://localhost:1313/", breadcrumb: true, carouselpostcount: 5, color: "auto", colorscheme: "auto", comment: "giscus", copyright: true, counttaxonomyposts: false, creativecommons: { by: true, nc: true, sa: true }, customcss: [], customjs: [], dateformat: ":date_long", description: "Welcome to decimo\u2019s Blog! I look forward to sharing this great journey with you.", diagram: false, docsnav: { reducefontsize: true }, featuredpostcount: 5, fixedheader: true, fullwidth: false, giscus: { category: "Announcements", categoryid: "DIC_kwDOQcBRNM4Cy98G", crossorigin: "anonymous", emitmetadata: false, favicon: false, inputposition: "bottom", lang: "zh-CN", loading: "lazy", mapping: "pathname", reactionsenabled: true, repo: "xiaochai-123/xiaochai-123.github.io", repoid: "R_kgDOQcBRNA", strict: false, theme: "preferred_color_scheme" }, logo: "images/logo.png", mainsections: ["posts", "docs"], palette: "blue", palettes: ["blue", "blue gray", "brown", "cyan", "green", "indigo", "orange", "pink", "purple", "red", "teal", "yellow"], pinnedpost: true, pinnedpostcount: 1, postdate: true, poweredby: true, readingtime: true, recentpostcount: 5, relatedpostcount: 5, reward: { wechat: "/images/wechat.jpg" }, sass_transpiler: "libsass", searchbar: true, showtoc: true, sidebartaxonomies: ["series", "categories", "tags", "authors"], social: { email: "mailto:l2556843965@163.com", github: "https://github.com/xiaochai-123" }, taxonomypaginate: 10, taxonomypostcount: 3, titlecase: false, titleseparator: "-", toc: true, tocposition: "sidebar", tocwordcount: 0, topappbar: { expandbreakpoint: "lg" }, viewer: true };
